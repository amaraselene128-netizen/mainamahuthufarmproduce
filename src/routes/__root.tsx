...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EGRATASKS — Premium Freelance & Micro-Task Marketplace" },
      { name: "description", content: "Join 1,000,000+ workers across 100+ countries on EGRATASKS — the premium global marketplace for microtasks, social engagement and freelance jobs." },
      { name: "author", content: "EGRATASKS" },
