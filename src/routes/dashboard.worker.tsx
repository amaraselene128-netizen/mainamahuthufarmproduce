...
export const Route = createFileRoute("/dashboard/worker")({
  head: () => ({ meta: [{ title: "Available tasks — EGRATASKS" }, { name: "robots", content: "noindex,nofollow" }] }),
...
function AvailableTasks() {
  ...
  async function load() {
    ...
    const { data, error } = await db.from("tasks")
      .select("id,title,description,payment_amount,tier,deadline,max_workers,current_workers,status,categories(name,slug)")
      .eq("status", "active")
