...
import { LayoutDashboard, Users, ListChecks, Headphones, Globe2, ShieldAlert, Wallet, Crown, Megaphone, Tv, Send, ShieldQuestion } from "lucide-react";
...
const items = [
  ...
  { to: "/admin/appeals", label: "Appeals", icon: ShieldQuestion },
